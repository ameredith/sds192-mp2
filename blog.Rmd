...
northEast + geom_polygon(data = joined, aes(fill = cand_party_affiliation), color = "white")+ geom_polygon(color = "black", fill = NA) +theme_bw() +
      ditch_the_axes
```
...
library(RgoogleMaps)
library(googleVis)
G4 <- gvisGeoChart(joined, locationvar='City', colorvar='Popularity',
